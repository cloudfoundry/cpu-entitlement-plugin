...
func (fake *FakeFetcher) FetchInstanceData(arg1 string, arg2 map[int]cf.Instance) (map[int]interface{}, error) {
...
func (fake *FakeFetcher) FetchInstanceDataCalls(stub func(string, map[int]cf.Instance) (map[int]interface{}, error)) {
	fake.fetchInstanceDataMutex.Lock()

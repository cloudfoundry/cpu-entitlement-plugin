...
func (fake *FakeMetricsFetcher) FetchInstanceData(arg1 string, arg2 map[int]cf.Instance) (map[int]interface{}, error) {
...
func (fake *FakeMetricsFetcher) FetchInstanceDataCalls(stub func(string, map[int]cf.Instance) (map[int]interface{}, error)) {
	fake.fetchInstanceDataMutex.Lock()
